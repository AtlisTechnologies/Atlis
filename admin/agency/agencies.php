...
<a href="agency_edit.php?organization_id=<?= $organization_id; ?>" class="btn btn-sm btn-success mb-3">Add Agency</a>
      ...
      <tbody class="list">
        <?php foreach($agencies as $a): ?>
          <tr>
            ...
            <td>
              <a class="btn btn-sm btn-warning" href="agency_edit.php?id=<?= $a['id']; ?>&organization_id=<?= $organization_id; ?>">Edit</a>
